    ...
    <div>
      <div className="grid grid-cols-1 mt-8 gap-2 items-center sm:grid-cols-2 sm:mt-15  md:gap-10 md:mt-15">
        ...
        <div className="box" data-aos="fade-left">
          ...
          <p className="my-1 text-[12px] md:text-md lg:text-[15px] sm:my-1 md:my-2 text-slate-900 mb-10 tracking-wide">
            {desk1}
          </p>
        </div>
        {/* Kanan */}
        ...
        >
          ...
          <p className="my-1 text-[12px] md:text-md lg:text-[15px] sm:my-1 md:my-2 text-slate-900 mb-10">
            {desk2}
          </p>
        </div>
