...
const Hope = () => {
  return (
    <div className="hope pt-20" id="hope">
      {/* title */}
      <div
      ...
      <div className="grid md:grid-cols-2 grid-cols-1 md:gap-10 gap-5 mt-10">
        ...
        />
        <ReactPlayers
          url={`../src/assets/video/mawar.mp4`}
        ...
        />
        <ReactPlayers
          url={`../src/assets/video/nabila.mp4`}
        ...
        />
        <ReactPlayers
          url={`../src/assets/video/puput.mp4`}
        ...
        />
        <ReactPlayers
          url={`../src/assets/video/nazwa.mp4`}
        ...
        />
        <ReactPlayers
          url={`../src/assets/video/resti.mp4`}
